...
insert into employees (id, schedule_id, unit_id, full_name, role_title, company_id, site_id, business_area_id)
values
  ('emp-ava', 'schedule-601', 'unit-casting', 'Ava Patel', 'Senior Operator', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-noah', 'schedule-602', 'unit-casting', 'Noah Kim', 'Relief Operator', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-jules', 'schedule-603', 'unit-casting', 'Jules Martin', 'Coordinator', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-mika', 'schedule-604', 'unit-casting', 'Mika Stone', 'Operator', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-siena', 'schedule-601', 'unit-casting', 'Siena Morales', 'Team Lead', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-owen', 'schedule-602', 'unit-casting', 'Owen Clarke', 'Operator', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-cam', 'schedule-601', 'unit-dispatch', 'Cam Russell', 'Dispatch Lead', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-lena', 'schedule-602', 'unit-dispatch', 'Lena Abbas', 'Yard Specialist', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-eli', 'schedule-603', 'unit-dispatch', 'Eli Foster', 'Coordinator', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-zara', 'schedule-604', 'unit-dispatch', 'Zara Shah', 'Relief Operator', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-kira', 'schedule-601', 'unit-packaging', 'Kira Walsh', 'Packaging Lead', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-joel', 'schedule-602', 'unit-packaging', 'Joel Park', 'Case Packer', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-maia', 'schedule-603', 'unit-packaging', 'Maia Chen', 'QA Tech', 'company-suncor', 'site-mildred-lake', 'business-area-sgd'),
  ('emp-rhett', 'schedule-604', 'unit-packaging', 'Rhett Cole', 'Forklift Operator', 'company-suncor', 'site-mildred-lake', 'business-area-sgd')
on conflict (id) do update
set
